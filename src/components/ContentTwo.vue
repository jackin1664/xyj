            ...
            <div class="content-top">
              <div class="middle-top">
                ...
                <div class="content-top-card">
                  <span class="content-top-num">总卡牌数量：20000张</span>
                  <span class="content-top-num">总卡牌数量：13000张</span>
                </div>
              </div>
                  ...
                  <div class="top-info-button">
                    <div class="top-info-usdt">
                      ...
                      <div class="top-info-iconbtn">
                        <img src="../assect/contentTwo/ten.png"/>
                      </div>
                    </div>
                    <div class="top-info-usdt">
                      <div class="top-info-money">
                      ...
                      <div class="top-info-iconbtn">
                        <img src="../assect/contentTwo/one.png"/>
                      </div>
                    </div>
                  </div>
                </div>
<!--                中间-->
                <div @click="goPack()" class="top-info-middle">
                    ...
                    <span class="info-middle-num">0</span>
                </div>
<!--                右边-->
